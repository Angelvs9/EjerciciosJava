public class cardiologo extends medico{
	private static final int COMISION=30;
	private String nombreEnfermera;
	cardiologo(String nombre,double precioVisita,int nmaxPacientes,boolean tarde,int nColegiado,String nombreEnfermera){
